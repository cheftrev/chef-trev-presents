...
const SECTIONS: LegalSection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      "Information you provide directly: when you submit an inquiry through our contact form, we collect the information you choose to share, which may include your name, email address, event type, date, guest count, location, budget range, and any message you send us.",
  ...
  },
  {
    ...
    list: [
      "Service providers who help us operate the Site and our business (such as our website host, form processor, analytics providers, and advertising platforms)",
  ...
  },
  {
    ...
    paragraphs: [
      "The Site is hosted on Netlify and uses Netlify Forms to process contact form submissions. We may also use third-party analytics and advertising services described in Section 3. These third parties have their own privacy policies governing their use of your information.",
    ],
  },
  {
    heading: "8. Data Retention",
    paragraphs: [
      "We retain the information you submit for as long as necessary to respond to your inquiry, fulfill any resulting booking, and comply with our legal and business record-keeping obligations.",
    ],
  },
  {
    heading: "9. Your Rights and Choices",
    paragraphs: [
      "Depending on where you live, you may have rights to access, correct, delete, or restrict the use of your personal information, and to opt out of certain data sharing, including for advertising purposes. You can also control cookies through your browser settings; disabling cookies may affect how the Site functions. To exercise any of these rights, contact us using the information in Section 12.",
    ],
  },
  {
